...
//			linkTablePd.put("linkFieldList",linkFieldList);
	...
	public void exportData(HttpServletRequest request, HttpServletResponse response, HttpSession session) throws Exception {
		...
		String tempPath = "";
		String toFile = "";
		tempPath = session.getServletContext().getRealPath("/") + "/template/excelExport/system_gencode.xls";
		toFile = session.getServletContext().getRealPath("/") + "/template/excelExport/temporary/system_gencode.xls";
	...
	public void gencode(HttpServletRequest request, HttpServletResponse response,HttpSession session) throws Exception  {
		...
		//生成List
		fprint("gencode/TemplateList.html.ftl", root, gen_path+tablePd.get("bus_name").toString()+File.separator+tablePd.get("mod_name").toString()+File.separator+FreemarkerParaUtil.html+tablePd.get("bus_name").toString()+"/"+tablePd.get("bus_name").toString()+"_list.html");
		//生成Add
		fprint("gencode/TemplateAdd.html.ftl", root, gen_path+tablePd.get("bus_name").toString()+File.separator+tablePd.get("mod_name").toString()+File.separator+FreemarkerParaUtil.html+tablePd.get("bus_name").toString()+"/"+tablePd.get("bus_name").toString()+"_add.html");
		//生成Update
		fprint("gencode/TemplateUpdate.html.ftl", root, gen_path+tablePd.get("bus_name").toString()+File.separator+tablePd.get("mod_name").toString()+File.separator+FreemarkerParaUtil.html+tablePd.get("bus_name").toString()+"/"+tablePd.get("bus_name").toString()+"_update.html");
		//生成Info
		fprint("gencode/TemplateInfo.html.ftl", root, gen_path+tablePd.get("bus_name").toString()+File.separator+tablePd.get("mod_name").toString()+File.separator+FreemarkerParaUtil.html+tablePd.get("bus_name").toString()+"/"+tablePd.get("bus_name").toString()+"_info.html");
		if(tablePd.get("more_add").toString().equals("1")){
			//生成AddMore
			fprint("gencode/TemplateAddMore.html.ftl", root, gen_path+tablePd.get("bus_name").toString()+File.separator+tablePd.get("mod_name").toString()+File.separator+FreemarkerParaUtil.html+tablePd.get("bus_name").toString()+"/"+tablePd.get("bus_name").toString()+"_addMore.html");
		}
		if(tablePd.get("temp_type").toString().equals("2")){
			//生成AddMore
			fprint("gencode/TemplateZtree.html.ftl", root, gen_path+tablePd.get("bus_name").toString()+File.separator+tablePd.get("mod_name").toString()+File.separator+FreemarkerParaUtil.html+tablePd.get("bus_name").toString()+"/"+tablePd.get("bus_name").toString()+"_ztree.html");
		}
		...
		if(Verify.verifyIsNotNull(menuPd)){
			...
			mPd.put("code",tablePd.get("mod_name")+"_"+tablePd.get("bus_name"));
...
//			param.put("content",StringEscapeUtils.escapeHtml(FileUtil.readFileContent(file)));
			param.put("content",FileUtil.readFileContent(file));
			list.add(param);
