...
//            }
            ...
            //生成list.jsp
            fprint("single/TemplateList.html.ftl", root, FreemarkerParaUtil.outputDir+"jsp/"+modelSb+File.separator+classSb.toString().toLowerCase()+"/"+classSb.toString().toLowerCase()+"_list.jsp");
            //生成list.jsp
            fprint("single/TemplateAdd.html.ftl", root, FreemarkerParaUtil.outputDir+"jsp/"+modelSb+File.separator+classSb.toString().toLowerCase()+"/"+classSb.toString().toLowerCase()+"_add.jsp");
            //生成list.jsp
            fprint("single/TemplateUpdate.html.ftl", root, FreemarkerParaUtil.outputDir+"jsp/"+modelSb+File.separator+classSb.toString().toLowerCase()+"/"+classSb.toString().toLowerCase()+"_update.jsp");
            //生成list.jsp
            fprint("single/TemplateInfo.html.ftl", root, FreemarkerParaUtil.outputDir+"jsp/"+modelSb+File.separator+classSb.toString().toLowerCase()+"/"+classSb.toString().toLowerCase()+"_info.jsp");
            if(isMore.equals("Y")){
                //生成addMore.jsp
                fprint("single/TemplateAddMore.html.ftl", root, FreemarkerParaUtil.outputDir+"jsp/"+modelSb+File.separator+classSb.toString().toLowerCase()+"/"+classSb.toString().toLowerCase()+"_addMore.jsp");
            }
    ...
    public void createMultiCode(HttpServletRequest request,HttpSession session){
        try {
            ...
            //生成list.jsp
            fprint("multi/TemplateList.html.ftl", root, FreemarkerParaUtil.outputDir+modelSb+File.separator+classSb.toString().toLowerCase()+"/"+classSb.toString().toLowerCase()+"_list.jsp");
            //生成list.jsp
            fprint("multi/TemplateAdd.html.ftl", root, FreemarkerParaUtil.outputDir+modelSb+File.separator+classSb.toString().toLowerCase()+"/"+classSb.toString().toLowerCase()+"_add.jsp");
            //生成list.jsp
            fprint("multi/TemplateUpdate.html.ftl", root, FreemarkerParaUtil.outputDir+modelSb+File.separator+classSb.toString().toLowerCase()+"/"+classSb.toString().toLowerCase()+"_update.jsp");
            //生成list.jsp
            fprint("multi/TemplateInfo.html.ftl", root, FreemarkerParaUtil.outputDir+modelSb+File.separator+classSb.toString().toLowerCase()+"/"+classSb.toString().toLowerCase()+"_info.jsp");
        } catch (SQLException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        } catch (Exception e) {
