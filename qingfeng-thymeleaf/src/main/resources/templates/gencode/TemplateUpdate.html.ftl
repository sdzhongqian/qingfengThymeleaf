    ...
    <#if tablePd.temp_type == '2'>
        <th:block th:if="${'$'}{p[parent_name]?:''==''}">
            <tr>
                ...
                <td colspan="3"><input type="text" readonly th:value="${tablePd.menu_name}" class="layui-input"></td>
            </tr>
        </th:block>
        <th:block th:if="${'$'}{p[parent_name]?:''!=''}">
            <tr>
                <td width="20%" align="right"><label class="layui-form-label">父级名称：<span style="color: red">*</span></label></td>
                <td colspan="3"><input type="text" readonly th:value="${'$'}{p[parent_name]?:'' }" class="layui-input"></td>
            </tr>
        </th:block>
    </#if>
<#list fieldList as obj>
    ...
    <#if obj.show_type == '1'||obj.show_type == '7'>
        <tr>
            ...
            <td colspan="3"><input type="text" name="${obj.field_name}" id="${obj.field_name}" th:value="${'$'}{p.${obj.field_name}}" lay-verify="${obj.verify_rule?replace(',','|')}" autocomplete="off" placeholder="${obj.field_comment}" class="layui-input"></td>
        </tr>
    </#if>
    <#if obj.show_type == '2'>
        <tr>
            ...
            <td colspan="3"><textarea name="${obj.field_name}" id="${obj.field_name}" lay-verify="${obj.verify_rule?replace(',','|')}" placeholder="请输入${obj.field_comment}" class="layui-textarea" th:text="${'$'}{p.${obj.field_name}}"></textarea></td>
        </tr>
    </#if>
    <#if obj.show_type == '3'>
        <tr>
            ...
            <td colspan="3">
                ...
                <#if obj.option_content?contains(";")>
                    ...
                    <option th:selected="${'$'}{p.${obj.field_name}=='${param[0]}'}" value="${param[0]}">${param[1]}</option>
                    </#list>
                </#if>
                </select>
            </td>
        ...
        <tr>
            ...
            <td colspan="3">
                ...
                <#if obj.option_content?contains(";")>
                    <#list obj.option_content?split(";") as name>
                    <#assign param = name?split("/")>
                    <input type="radio" th:checked="${'$'}{p.${obj.field_name}=='${param[0]}'}" name="${obj.field_name}" value="${param[0]}" title="${param[1]}" lay-verify="${obj.verify_rule?replace(',','|')}">
                    </#list>
                </#if>
                </div>
            </td>
        ...
        <tr>
            ...
            <td colspan="3">
                ...
                <#if obj.option_content?contains(";")>
                    <#list obj.option_content?split(";") as name>
                    <#assign param = name?split("/")>
                    <input type="checkbox" lay-filter='checkField' th:checked="${'$'}{p.${obj.field_name}.indexOf('${param[0]}')!=-1}" name="div-${obj.field_name}" value="${param[0]}" lay-skin="primary" title="${param[1]}" lay-verify="${obj.verify_rule?replace(',','|')}">
                    </#list>
                </#if>
                </div>
                <input type="hidden" name="${obj.field_name}" id="${obj.field_name}" th:value="${'$'}{p.${obj.field_name}}" />
            </td>
        </tr>
    </#if>
    <#if obj.show_type == '6'>
        ...
        <tr>
            ...
            <td colspan="3">
                <script type="text/plain" id="richText_${obj.field_name}" style="width: 100%;height:500px;" th:text="${'$'}{p.${obj.field_name}}"></script>
        ...
        <tr>
            ...
            <td colspan="3">
                <div style="margin-top:5px;">
                    <input type="hidden" name="${obj.field_name}" id="fileIds_${obj.field_name}" th:value="${'$'}{p.${obj.field_name}}" class="layui-input">
                            ...
                            <tr th:id="'tr_ls'+${'$'}{v.id}">
                                ...
                                <td>
                                    <div class="layui-btn-group">
                                        ...
                                        <button type="button" th:onclick="delMoreFile('ls'+[[${'$'}{v.id}]],[[${'$'}{v.id}]],[[${'$'}{v.file_path}]]);" class="layui-btn layui-btn-xs layui-btn-danger">删除</button>
                                    </div>
                                </td>
                            </tr>
                        </th:block>
                        ...
                        <th:block th:each="var,status:${'$'}{list}">
                            <tr id="child_tr_ls${'$'}{var.id}">
                                <#list linkFieldList as obj>
                                    <#if obj.field_operat == 'Y'>
                                        <#if obj.show_type == '1'||obj.show_type == '7'>
                                            <td><input type="text" name="child_${obj.field_name}" id="${obj.field_name}_1" th:value="${'$'}{var.${obj.field_name}}" lay-verify="${obj.verify_rule?replace(',','|')}" autocomplete="off" placeholder="${obj.field_comment}" class="layui-input"></td>
                                        </#if>
                                        <#if obj.show_type == '2'||obj.show_type == '6'>
                                            <td><textarea name="child_${obj.field_name}" id="${obj.field_name}_1" lay-verify="${obj.verify_rule?replace(',','|')}" placeholder="请输入${obj.field_comment}" class="layui-textarea" th:text="${'$'}{var.${obj.field_name}}"></textarea></td>
                                        </#if>
                                        <#if obj.show_type == '3'>
                                            <td>
                                                <select name="child_${obj.field_name}" id="${obj.field_name}_1" lay-verify="${obj.verify_rule?replace(',','|')}" style="height: 32px;" class="layui-input">
                                                    ...
                                                    <#if obj.option_content?contains(";")>
                                                        <#list obj.option_content?split(";") as name>
                                                            <#assign param = name?split("/")>
                                                            <option th:selected="${'$'}{var.${obj.field_name}=='${param[0]}'}" value="${param[0]}">${param[1]}</option>
                                                        </#list>
                                                    </#if>
                                                </select>
                                            </td>
                                        ...
                                        <#if obj.show_type == '4'>
                                            <td>
                                                <div th:id="'div_'+${'$'}{var.id}+'_${obj.field_name}'">
                                                    <#if obj.option_content?contains(";")>
                                                        <#list obj.option_content?split(";") as name>
                                                            <#assign param = name?split("/")>
                                                            <input type="radio" th:checked="${'$'}{var.${obj.field_name}=='${param[0]}'}" name="child_${obj.field_name}" value="${param[0]}" title="${param[1]}" lay-verify="${obj.verify_rule?replace(',','|')}">
                                                        </#list>
                                                    </#if>
                                                </div>
                                            </td>
                                        ...
                                        <#if obj.show_type == '5'>
                                            <#assign checkboxText = 'true'>
                                            <td>
                                                <div th:id="'div-'+${'$'}{var.id}+'-${obj.field_name}'">
                                                    <#if obj.option_content?contains(";")>
                                                        <#list obj.option_content?split(";") as name>
                                                            <#assign param = name?split("/")>
                                                            <input type="checkbox" lay-filter='checkField' th:checked="${'$'}{var.${obj.field_name}.indexOf('${param[0]}')!=-1}" th:name="'div-'+${'$'}{var.id}+'-${obj.field_name}'" value="${param[0]}" lay-skin="primary" title="${param[1]}" lay-verify="${obj.verify_rule?replace(',','|')}">
                                                        </#list>
                                                    </#if>
                                                </div>
                                                <input type="hidden" name="child_${obj.field_name}" th:id="'${obj.field_name}_'+${'$'}{var.id}" th:value="${'$'}{var.${obj.field_name}}" />
                                            </td>
                                        </#if>
                                        <#if obj.show_type == '8'>
                                            <td>
                                                <div style="margin-top:5px;">
                                                    <input type="hidden" name="child_${obj.field_name}" th:id="'fileIds_${obj.field_name}_'+${'$'}{var.id}" th:value="${'$'}{var.${obj.field_name}}" class="layui-input">
                                                    <button type="button" class="layui-btn layui-btn-xs" th:id="'upload_file_${obj.field_name}_'+${'$'}{var.id}">选择附件</button>
                                                    <table class="layui-table">
                                                        <thead>
                                                        <tr>
                                                            <th>附件名称</th>
                                ...
                                <td style="width:60px;">
                                    <div class="layui-btn-group">
                                        <input type="hidden" name="c_ids" th:value="${'$'}{var.id}">
                                        ...
                                        <th:block th:if="${'$'}{status.index!=1}">
                                            <button type="button" th:onclick="delLine('ls'+[[${'$'}{var.id}]]);" class="layui-btn layui-btn-xs layui-btn-danger"><i class="layui-icon"></i></button>
                                        </th:block>
                                    </div>
                                </td>
                            </tr>
                    ...
                    <th:block th:if="${'$'}{list.size()==0}">
                        <tr>
                            <#list linkFieldList as obj>
                                <#if obj.field_operat == 'Y'>
                                    <#if obj.show_type == '1'||obj.show_type == '7'>
                                        <td><input type="text" name="child_${obj.field_name}" id="${obj.field_name}_1" th:value="${obj.default_value}" lay-verify="${obj.verify_rule?replace(',','|')}" autocomplete="off" placeholder="${obj.field_comment}" class="layui-input"></td>
                                    </#if>
                                    <#if obj.show_type == '2'||obj.show_type == '6'>
                                        <td><textarea name="child_${obj.field_name}" id="${obj.field_name}_1" lay-verify="${obj.verify_rule?replace(',','|')}" placeholder="请输入${obj.field_comment}" class="layui-textarea" th:text="${obj.default_value}"></textarea></td>
                                    </#if>
                                    <#if obj.show_type == '3'>
                                        <td>
                                            <select name="child_${obj.field_name}" id="${obj.field_name}_1" lay-verify="${obj.verify_rule?replace(',','|')}" style="height: 32px;" class="layui-input">
...
${'$'}.each([(${'$'}{listJson})],function(i,n){
        ...
        <#list fieldList as obj>
            ...
            ${'$'}.ajax({
                ...
                url: ctx+"${tablePd.mod_name}/${tablePd.bus_name}/update" ,//url
                data: ${'$'}('#form').serialize(),
    ...
    function delLine(index){
        ...
        ${'$'}.ajax({
                type: "GET",//方法类型
                dataType: "json",//预期服务器返回的数据类型
                url: ctx+"${tablePd.mod_name}/${tablePd.bus_name}/delChild?ids="+id,//url
                data: "",
                success: function (res) {
                    if (res.success) {
